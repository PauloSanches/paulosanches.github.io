(function(window, undefined) {
  ...
  var OgvAd = (function() {
    ...
    var init = function() {
      ...
      $s('.' + getOrientacao() + ' .arraste-aqui').on('mousedown', onMouseDown);
      $s('.' + getOrientacao() + ' .arraste-aqui').on('mouseup', onMouseUp);
    ...
    var onMouseDown = function(event) {
      $s('.' + getOrientacao() + ' .arraste-aqui').on('mousemove', OgvAd.touch.touchMove);
      OgvAd.touch.touchStart(event);
    }

    var onMouseUp = function(event) {
      $s('.' + getOrientacao() + ' .arraste-aqui').off('mousemove', OgvAd.touch.touchMove);
      OgvAd.touch.touchEnd(event);
    }
    /**
     * Finaliza a peça.
     */
