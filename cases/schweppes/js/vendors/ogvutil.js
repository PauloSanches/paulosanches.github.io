(function () {
	...
	var $u = (function () {
		/**
        Cria um setTimeout recebendo um callback e uma duração.

        @method timer
        @param {Function} callback Função a ser chamada pelo setTimeout.
        @param {Number} duration Tempo (em segundos) para chamar o callback.
        @return {Function}
        **/
