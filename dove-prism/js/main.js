(function(OgvAd) {
	...
	var Main = (function() {
		...
		function init() {
			portrait.addEventListener('touchstart', touchStart, false);
			portrait.addEventListener('touchmove', touchMove, false);
			portrait.addEventListener('touchend', touchEnd, false);
		}
